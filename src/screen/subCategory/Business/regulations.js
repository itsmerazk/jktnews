...
export default function Regulations() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('https://jakpost.vercel.app/api/category/business/regulations');
        ...
        <div className="min-h-screen bg-gray-100">
           <div className="container px-4 py-8 mx-auto">
              ...
              {posts.map((post, index) => (
                ...
                <h2 className="mb-2 text-xl font-semibold">{featuredPost.title}</h2>
