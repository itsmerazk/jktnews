...
export default function MiddleEasAfrica() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('https://jakpost.vercel.app/api/category/world/middle-east-africa');
                const data = response.data;
                setFeaturedPost(data.feature_post);
                setPosts(data.posts);
