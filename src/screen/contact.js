  ...
  return (
    <div>
      ...
      <div className="container mx-auto mt-8">
        ...
        <p className="text-gray-700">Kami senang mendengar dari Anda! Hubungi kami melalui salah satu saluran berikut:</p>
        <ul className="mt-2 text-gray-700 list-disc list-inside">
          <li>Email: info@jktnews.com</li>
          <li>Telepon: 123-456-7890</li>
          <li>Alamat: Jalan ABC No. 123, Jakarta, Indonesia</li>
        </ul>
      </div>
